...
export const config = {
  ...
  brand: {
    ...
    fullName: `${process.env.NEXT_PUBLIC_BRAND_NAME || "Kumoart"} ${
      process.env.NEXT_PUBLIC_BRAND_TAGLINE || "Handmade"
    }`,
  },
  ...
  // Site Settings
  site: {
    url: process.env.NEXT_PUBLIC_SITE_URL || "https://kumoart-craft.vercel.app",
